...
const buildingTeam = (employees) => {
        ...
        let managerProfile = `
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><a href = "mailto: ${manager.email}" class ='links'>${manager.email}</a></li>
            ...
            let engineerProfile = `
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><a href = "mailto: ${engineer.email}" class ='links'>${engineer.email}</a></li>
                        <li class="list-group-item"><a href='https://github.com/${engineer.github}' target='_blank' rel = 'noopener' class = 'links'>${engineer.github}</a></li>
                    </ul>
                </div>
            `;
            ...
            let internProfile = `
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><a href = "mailto: ${intern.email}" class ='links'>${intern.email}</a></li>
    ...
    for (const element of employees) {
        if (element.position() === "Intern") {
            buildingInternProfile(element)
        } else if (element.position() === "Manager") {
            buildingManagerProfile(element)
        } else {
            buildingEngineerProfile(element)
        }
    }
